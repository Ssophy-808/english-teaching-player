  ...
  function makeUnit1Lesson(unit, day, dayGoal, phases) {
    ...
    return {
      ...
      dailyHandout: {
        ...
        pageStart: ((day - 1) * 4) + 1,
        pageEnd: day * 4,
        studentUrl: "assets/handouts/book1/unit1/book1-unit1-daily-handouts.pdf?v=4",
        teacherUrl: "assets/handouts/book1/unit1/book1-unit1-teacher-key.pdf?v=4"
      },
      steps,
  ...
  function makeBook2Unit1Lesson(unit, day, dayGoal, phases) {
    ...
    return {
      ...
      dailyHandout: {
        ...
        pageStart: ((day - 1) * 4) + 1,
        pageEnd: day * 4,
        studentUrl: "assets/handouts/book2/unit1/book2-unit1-daily-handouts.pdf?v=4",
        teacherUrl: "assets/handouts/book2/unit1/book2-unit1-teacher-key.pdf?v=4"
      },
      steps
    };
  }
  ...
  function makeBook3Unit1Lesson(unit, day, dayGoal, phases) {
    ...
    return {
      ...
      dailyHandout: {
        ...
        pageStart: firstPage,
        pageEnd: firstPage + 3,
        studentUrl: "assets/handouts/book3/unit1/book3-unit1-daily-handouts.pdf?v=3",
        teacherUrl: "assets/handouts/book3/unit1/book3-unit1-teacher-key.pdf?v=3"
      },
